\ К конкурсу решения задач на форте (http://fforum.winglion.ru/viewtopic.php?p=7274#7274)
...
wordsEntered @ DROPB
TAKE-THREE <*>
0. 2DROPB 1000000 DROPB TAKE-THREE <* \ добавляем elem в массив для не успевшей обработаться строки
}arr
\ 2DUP DUMP EXIT
DROP
